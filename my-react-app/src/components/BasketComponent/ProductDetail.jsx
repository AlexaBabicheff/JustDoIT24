...
//   // Add logic to increase the total price
//   const total = items.reduce((acc, curr) => acc + (curr.count * curr.price), 0);
//   dispatch(increaseTotalPrice(total));
//   };
  
//   const decreaseCount = (id) => {
//   dispatch(decreaseItemCount(id));
//   // Add logic to decrease the total price
//   const total = items.reduce((acc, curr) => acc - (curr.count * curr.price), 0);
//   dispatch(decreaseTotalPrice(total));
//   };
  
//   const removeItem = (id) => {
//   dispatch(removeItemFromCart(id));
//   // Add logic to remove the item from the total price
//   const total = items.reduce((acc, curr) => acc - (curr.count * curr.price), 0);
//   dispatch(removeFromTotalPrice(total));
//   };
